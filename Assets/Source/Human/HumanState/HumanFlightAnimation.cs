...
public sealed partial class HumanFlightState
{
    public sealed class HumanFlightAnimation : HumanAnimation
    {
        ...
        protected override void Animate()
        {
            ...
            LeftLeg.Rotate(Quaternion.Euler(backWingRotation.x * 0.5f, backWingRotation.y * 0.5f, -state.backWing.WingArea * wingOpenAngle * 0.5f + legAngleBase));
            RightLeg.Rotate(Quaternion.Euler(backWingRotation.x * 0.5f, backWingRotation.y * 0.5f, state.backWing.WingArea * wingOpenAngle * 0.5f - legAngleBase));
            ...
            LeftArm.Rotate(Quaternion.Euler(state.leftWing.WingRotation.x * cosmeticRotationMultiplier, state.leftWing.WingRotation.y * cosmeticRotationMultiplier, -state.leftWing.WingArea * wingOpenAngle));
            RightArm.Rotate(Quaternion.Euler(state.rightWing.WingRotation.x * cosmeticRotationMultiplier, state.rightWing.WingRotation.y * cosmeticRotationMultiplier, state.rightWing.WingArea * wingOpenAngle));
        }
    }
}